...
function Edit(props) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    const fetchCategories = async () => {
      try {
        const response = await fetch("/wp-json/wp/v2/category_events?hide_empty=true&per_page=100&_fields=id,name,slug,count");
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    ...
    const fetchPosts = async () => {
      setLoading(true);
      try {
        const selectedCategory = categories.find(category => category.slug === eventCategory);
        ...
        const response = await fetch(`/wp-json/wp/v2/events?${params.toString()}`);
        const data = await response.json();
    ...
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsxs)(_mantine_core__WEBPACK_IMPORTED_MODULE_3__.MantineProvider, {
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_9__.InspectorControls, {
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__.PanelBody, {
          ...
          initialOpen: true,
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_11__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_10__.SelectControl, {
            label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Category", "eara"),
            value: eventCategory,
            options: [{
              label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("All categories", "eara"),
              value: ""
