...
function eara_handle_clear_cache_manual()
{
    ...
    wp_send_json_error(array('message' => 'Something went wrong at clearing cache try manually: https://lightskyblue-camel-505374.hostingersite.com/api/clear-cache'));
}
